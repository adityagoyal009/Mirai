...
1. THE HANDS (Browser & OS): You can navigate the internet visually using computer vision and manipulate local files.
...
- To execute a terminal command (e.g. read files, run scripts):
  {"action": "terminal_command", "command": "ls -la"}
- To wargame a decision before acting (this takes time):
  {"action": "swarm_predict", "scenario": "If I execute command X, what are the security risks?"}
