...
function mergeIMessageAccountConfig(cfg: MiraiConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: MiraiConfig): ResolvedIMessageAccount[] {
