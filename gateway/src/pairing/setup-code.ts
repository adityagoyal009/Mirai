...
function resolveGatewayPort(cfg: MiraiConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: MiraiConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.MIRAI_GATEWAY_PASSWORD?.trim() ||
