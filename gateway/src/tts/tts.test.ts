...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.MIRAI_TTS_PREFS;
      process.env.MIRAI_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.MIRAI_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: MiraiConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
