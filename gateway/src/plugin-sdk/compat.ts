...
if (shouldWarnCompatImport) {
  process.emitWarning(
    "openclaw/plugin-sdk/compat is deprecated for new plugins. Migrate to focused openclaw/plugin-sdk/<subpath> imports. See https://github.com/adityagoyal009/Mirai/tree/main/gateway/docs/plugins/sdk-migration",
    {
