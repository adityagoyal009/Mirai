...
function mergeSignalAccountConfig(cfg: MiraiConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: MiraiConfig): ResolvedSignalAccount[] {
