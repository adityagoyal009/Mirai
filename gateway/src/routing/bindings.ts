...
export function listBindings(cfg: MiraiConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: MiraiConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: MiraiConfig) {
