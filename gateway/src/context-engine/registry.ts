...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("mirai.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("mirai.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: MiraiConfig): Promise<ContextEngine> {
