...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): MiraiConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: MiraiConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: MiraiConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
