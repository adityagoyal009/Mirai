...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<MiraiConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<MiraiConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: MiraiConfig): WebSearchConfig {
