...
type WebSearchConfig = NonNullable<MiraiConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: MiraiConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("mirai configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.mirai.ai/tools/web",
  };
}
