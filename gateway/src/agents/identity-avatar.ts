...
function resolveAvatarSource(cfg: MiraiConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: MiraiConfig, agentId: string): AgentAvatarResolution {
