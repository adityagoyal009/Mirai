...
function resolveWatchPaths(workspaceDir: string, config?: MiraiConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: MiraiConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: MiraiConfig }) {
