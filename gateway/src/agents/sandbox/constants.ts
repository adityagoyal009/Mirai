...
export const DEFAULT_SANDBOX_IMAGE = "mirai-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "mirai-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "mirai-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "mirai-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "mirai-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "mirai-sandbox-browser";
