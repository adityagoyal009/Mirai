...
export const createMiraiCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createMiraiCodingToolsMock.mockReset();
  createMiraiCodingToolsMock.mockReturnValue([]);
}
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureMiraiModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveMiraiDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createMiraiCodingTools: createMiraiCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveMiraiAgentDir: vi.fn(() => "/tmp"),
  }));
