...
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    ...
    "See: https://github.com/adityagoyal009/Mirai/tree/main/gateway/docs/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "mirai configure". ' +
    "See: https://github.com/adityagoyal009/Mirai/tree/main/gateway/docs/providers/vllm",
};
