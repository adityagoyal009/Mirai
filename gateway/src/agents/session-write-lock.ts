...
const CLEANUP_STATE_KEY = Symbol.for("mirai.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("mirai.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("mirai.sessionWriteLockWatchdogState");
