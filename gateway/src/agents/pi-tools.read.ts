...
function resolveAdaptiveReadMaxBytes(options?: MiraiReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createMiraiReadTool(base, {
...
export function createMiraiReadTool(
  base: AnyAgentTool,
  options?: MiraiReadToolOptions,
): AnyAgentTool {
