...
export type MiraiPluginConfigSchema = {
...
export type MiraiPluginToolContext = {
  config?: MiraiConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type MiraiPluginToolFactory = (
  ctx: MiraiPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type MiraiPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type MiraiPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<MiraiConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type MiraiPluginGatewayMethod = {
  method: string;
 ...
 */
export type MiraiPluginCommandDefinition = {
...
export type MiraiPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type MiraiPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type MiraiPluginCliContext = {
  program: Command;
  config: MiraiConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type MiraiPluginCliRegistrar = (ctx: MiraiPluginCliContext) => void | Promise<void>;

export type MiraiPluginServiceContext = {
  config: MiraiConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type MiraiPluginService = {
  id: string;
  start: (ctx: MiraiPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: MiraiPluginServiceContext) => void | Promise<void>;
};

export type MiraiPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type MiraiPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  ...
  register?: (api: MiraiPluginApi) => void | Promise<void>;
  activate?: (api: MiraiPluginApi) => void | Promise<void>;
};

export type MiraiPluginModule =
  | MiraiPluginDefinition
  | ((api: MiraiPluginApi) => void | Promise<void>);

export type MiraiPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | MiraiPluginToolFactory,
    opts?: MiraiPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: MiraiPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: MiraiPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: MiraiPluginHttpRouteHandler }) => void;
  registerChannel: (registration: MiraiPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: MiraiPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: MiraiPluginService) => void;
   ...
   */
  registerCommand: (command: MiraiPluginCommandDefinition) => void;
