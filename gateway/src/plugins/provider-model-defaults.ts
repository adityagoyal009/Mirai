...
export function applyGoogleGeminiModelDefault(cfg: MiraiConfig): {
  next: MiraiConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: MiraiConfig): MiraiConfig {
...
export function applyOpenAIConfig(cfg: MiraiConfig): MiraiConfig {
...
export function applyOpencodeGoModelDefault(cfg: MiraiConfig): {
  next: MiraiConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: MiraiConfig): {
  next: MiraiConfig;
  changed: boolean;
} {
