...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/mirai/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/mirai/extensions",
        global: "/Users/x/.mirai/extensions",
        workspace: "/Users/x/ws/.mirai/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.mirai/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/mirai/extensions",
        global: "/Users/x/.mirai/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.mirai/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/mirai/extensions",
        global: "/Users/x/.mirai/extensions",
