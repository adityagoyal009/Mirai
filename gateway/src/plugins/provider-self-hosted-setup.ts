...
export function applyProviderDefaultModel(cfg: MiraiConfig, modelRef: string): MiraiConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: MiraiConfig; modelId: string; modelRef: string; profileId: string } {
