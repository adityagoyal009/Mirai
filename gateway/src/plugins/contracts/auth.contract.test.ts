...
import type { MiraiPluginApi, ProviderPlugin } from "../types.js";

type LoginOpenAICodexOAuth =
  (typeof import("mirai-gateway/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
...
type GithubCopilotLoginCommand =
  (typeof import("mirai-gateway/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type CreateVpsAwareHandlers =
  (typeof import("../provider-oauth-flow.js"))["createVpsAwareOAuthHandlers"];
type EnsureAuthProfileStore =
  typeof import("mirai-gateway/plugin-sdk/agent-runtime").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("mirai-gateway/plugin-sdk/agent-runtime").listProfilesForProvider;
...
vi.mock("mirai-gateway/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("mirai-gateway/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("mirai-gateway/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("mirai-gateway/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
...
function registerProviders(...plugins: Array<{ register(api: MiraiPluginApi): void }>) {
