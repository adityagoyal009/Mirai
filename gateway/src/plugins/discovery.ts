...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @mirai/voice-call -> voice-call).
...
export function discoverMiraiPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".mirai", "extensions")];
