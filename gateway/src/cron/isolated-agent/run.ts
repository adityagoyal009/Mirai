...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/mirai/mirai/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.MIRAI_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.mirai/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: MiraiConfig = {
    ...params.cfg,
