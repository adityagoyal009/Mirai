...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.mirai.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", MIRAI_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.mirai.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when MIRAI_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.mirai.gateway.plist",
    },
    {
      name: "uses profile-specific label when MIRAI_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", MIRAI_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.mirai.jbphoenix.plist",
    },
    {
      name: "prefers MIRAI_LAUNCHD_LABEL over MIRAI_PROFILE",
      env: {
        HOME: "/Users/test",
        MIRAI_PROFILE: "jbphoenix",
        MIRAI_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from MIRAI_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        MIRAI_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty MIRAI_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        MIRAI_PROFILE: "myprofile",
        MIRAI_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.mirai.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
