...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.MIRAI_STATE_DIR;
  const configPath = env.MIRAI_CONFIG_PATH;
  ...
  return {
    ...
    ...proxyEnv,
    MIRAI_PROFILE: profile,
    MIRAI_STATE_DIR: stateDir,
    MIRAI_CONFIG_PATH: configPath,
    MIRAI_GATEWAY_PORT: String(port),
    MIRAI_GATEWAY_TOKEN: token,
    MIRAI_LAUNCHD_LABEL: resolvedLaunchdLabel,
    MIRAI_SYSTEMD_UNIT: systemdUnit,
    MIRAI_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    MIRAI_SERVICE_KIND: GATEWAY_SERVICE_KIND,
    MIRAI_SERVICE_VERSION: VERSION,
  };
}
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    MIRAI_STATE_DIR: stateDir,
    MIRAI_CONFIG_PATH: configPath,
    MIRAI_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    MIRAI_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    MIRAI_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    MIRAI_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    MIRAI_LOG_PREFIX: "node",
    MIRAI_SERVICE_MARKER: NODE_SERVICE_MARKER,
    MIRAI_SERVICE_KIND: NODE_SERVICE_KIND,
    MIRAI_SERVICE_VERSION: VERSION,
  };
}
