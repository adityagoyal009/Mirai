...
export const A2UI_PATH = "/__mirai__/a2ui";

export const CANVAS_HOST_PATH = "/__mirai__/canvas";

export const CANVAS_WS_PATH = "/__mirai__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.miraiCanvasA2UIAction.postMessage(...)
  // - Android: window.miraiCanvasA2UIAction.postMessage(...)
  const handlerNames = ["miraiCanvasA2UIAction"];
  ...
  globalThis.Mirai = globalThis.Mirai ?? {};
  globalThis.Mirai.postMessage = postToNode;
  globalThis.Mirai.sendUserAction = sendUserAction;
  globalThis.miraiPostMessage = postToNode;
  globalThis.miraiSendUserAction = sendUserAction;
