...
const shouldRegisterPrimaryOnly = (argv: string[]) => {
  if (isTruthyEnvValue(process.env.MIRAI_DISABLE_LAZY_SUBCOMMANDS)) {
    return false;
  }
...
const shouldEagerRegisterSubcommands = (_argv: string[]) => {
  return isTruthyEnvValue(process.env.MIRAI_DISABLE_LAZY_SUBCOMMANDS);
};

const loadConfig = async (): Promise<MiraiConfig> => {
...
const entries: SubCliEntry[] = [
  ...
  {
    name: "docs",
    description: "Search the live Mirai docs",
    hasSubcommands: false,
    register: async (program) => {
  ...
  {
    name: "plugins",
    description: "Manage Mirai plugins and extensions",
    hasSubcommands: true,
    register: async (program) => {
  ...
  {
    name: "update",
    description: "Update Mirai and inspect update channel status",
    hasSubcommands: true,
    register: async (program) => {
