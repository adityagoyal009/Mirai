...
${formatHelpExamples([
  ['mirai agent --to +15555550123 --message "status update"', "Start a new session."],
  ['mirai agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'mirai agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'mirai agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['mirai agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'mirai agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
