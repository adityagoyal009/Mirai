...
const EXAMPLES = [
  ["mirai models --help", "Show detailed help for the models command."],
  [
    "mirai channels login --verbose",
    "Link personal WhatsApp Web and show QR + connection logs.",
  ],
  [
    'mirai message send --target +15555550123 --message "Hi" --json',
    "Send via your web session and print JSON result.",
  ],
  ["mirai gateway --port 18789", "Run the WebSocket Gateway locally."],
  ["mirai --dev gateway", "Run a dev Gateway (isolated state/config) on ws://127.0.0.1:19001."],
  ["mirai gateway --force", "Kill anything bound to the default gateway port, then start it."],
  ["mirai gateway ...", "Gateway control via WebSocket."],
  [
    'mirai agent --to +15555550123 --message "Run summary" --deliver',
    "Talk directly to the agent using the Gateway; optionally send the WhatsApp reply.",
  ],
  [
    'mirai message send --channel telegram --target @mychat --message "Hi"',
