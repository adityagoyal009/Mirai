    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mirai directory self --channel slack", "Show the connected account identity."],
          [
            'mirai directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["mirai directory groups list --channel discord", "List available groups/channels."],
          [
            "mirai directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "github.com/adityagoyal009/Mirai/tree/main/gateway/docs/cli/directory",
        )}\n`,
    )
    .action(() => {
