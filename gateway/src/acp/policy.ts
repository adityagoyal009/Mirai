...
export function isAcpEnabledByPolicy(cfg: MiraiConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: MiraiConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: MiraiConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: MiraiConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: MiraiConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: MiraiConfig, agentId: string): boolean {
