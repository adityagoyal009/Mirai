...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: MiraiConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: MiraiConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: MiraiConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: MiraiConfig }): Promise<void> {
