...
export function hasAmbiguousGatewayAuthModeConfig(cfg: MiraiConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: MiraiConfig): void {
