...
export function collectConfiguredModelPricingRefs(config: MiraiConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: MiraiConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
