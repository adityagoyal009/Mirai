...
function listConfiguredAgentIds(cfg: MiraiConfig): string[] {
...
export function listAgentsForGateway(cfg: MiraiConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: MiraiConfig): string {
...
function resolveSessionStoreAgentId(cfg: MiraiConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: MiraiConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: MiraiConfig): GatewaySessionsDefaults {
