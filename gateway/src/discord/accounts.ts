...
function mergeDiscordAccountConfig(cfg: MiraiConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: MiraiConfig): ResolvedDiscordAccount[] {
