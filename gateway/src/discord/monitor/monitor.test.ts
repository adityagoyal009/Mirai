...
describe("agent components", () => {
  const createCfg = (): MiraiConfig => ({}) as MiraiConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/mirai-sessions-test.json");
  });
