...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: MiraiConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__miraiMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__miraiMcporterColdStartWarned;
  });
