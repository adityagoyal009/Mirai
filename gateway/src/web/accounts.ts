...
export function listWhatsAppAuthDirs(cfg: MiraiConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: MiraiConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: MiraiConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: MiraiConfig): ResolvedWhatsAppAccount[] {
