...
export const FIELD_HELP: Record<string, string> = {
  ...
  "wizard.lastRunVersion":
    "Mirai version recorded at the time of the most recent wizard run on this config. Use this when diagnosing behavior differences across version-to-version onboarding changes.",
  ...
  "agents.defaults.sandbox.browser.network":
    "Docker network for sandbox browser containers (default: mirai-sandbox-browser). Avoid bridge if you need stricter isolation.",
  ...
  "gateway.controlUi.basePath":
    "Optional URL prefix where the Control UI is served (e.g. /mirai).",
  ...
  "diagnostics.cacheTrace.filePath":
    "JSONL output path for cache trace logs (default: $MIRAI_STATE_DIR/logs/cache-trace.jsonl).",
  ...
  "agents.defaults.memorySearch.store.path":
    "Sets where the SQLite memory index is stored on disk for each agent. Keep the default `~/.mirai/memory/{agentId}.sqlite` unless you need custom storage placement or backup policy alignment.",
  ...
  "plugins.installs.*.installPath":
    "Resolved install directory (usually ~/.mirai/extensions/<id>).",
