...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated mirai relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedMiraiRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-mirai-relay-token",
