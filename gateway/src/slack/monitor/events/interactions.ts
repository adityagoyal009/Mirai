...
// Prefix for Mirai-generated action IDs to scope our handler
const MIRAI_ACTION_PREFIX = "mirai:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${MIRAI_ACTION_PREFIX}`);

  // Handle Mirai modal submissions with callback_ids scoped by our prefix.
