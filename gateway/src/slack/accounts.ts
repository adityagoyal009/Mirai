...
function mergeSlackAccountConfig(cfg: MiraiConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: MiraiConfig): ResolvedSlackAccount[] {
