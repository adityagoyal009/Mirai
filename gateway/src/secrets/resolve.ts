...
function resolveResolutionLimits(config: MiraiConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: MiraiConfig): SecretProviderConfig {
