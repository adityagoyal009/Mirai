...
export function listAuthProfileStorePaths(config: MiraiConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: MiraiConfig, stateDir: string): string[] {
