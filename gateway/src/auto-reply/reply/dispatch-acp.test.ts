...
const policyMocks = vi.hoisted(() => ({
  resolveAcpDispatchPolicyError: vi.fn<(cfg: MiraiConfig) => AcpRuntimeError | null>(() => null),
  resolveAcpAgentPolicyError: vi.fn<(cfg: MiraiConfig, agent: string) => AcpRuntimeError | null>(
    () => null,
  ),
}));
...
const ttsMocks = vi.hoisted(() => ({
  ...
  resolveTtsConfig: vi.fn((_cfg: MiraiConfig) => ({ mode: "final" })),
}));

const sessionMetaMocks = vi.hoisted(() => ({
  readAcpSessionEntry: vi.fn<
    (params: { sessionKey: string; cfg?: MiraiConfig }) => AcpSessionStoreEntry | null
  >(() => null),
}));
...
vi.mock("../../acp/policy.js", () => ({
  resolveAcpDispatchPolicyError: (cfg: MiraiConfig) =>
    policyMocks.resolveAcpDispatchPolicyError(cfg),
  resolveAcpAgentPolicyError: (cfg: MiraiConfig, agent: string) =>
...
vi.mock("../../tts/tts.js", () => ({
  ...
  resolveTtsConfig: (cfg: MiraiConfig) => ttsMocks.resolveTtsConfig(cfg),
}));

vi.mock("../../acp/runtime/session-meta.js", () => ({
  readAcpSessionEntry: (params: { sessionKey: string; cfg?: MiraiConfig }) =>
...
function createAcpConfigWithVisibleToolTags(): MiraiConfig {
