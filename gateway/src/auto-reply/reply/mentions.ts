...
function resolveMentionPatterns(cfg: MiraiConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: MiraiConfig | undefined, agentId?: string): RegExp[] {
