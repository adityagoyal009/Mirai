...
function resolveAcpStreamCoalesceIdleMs(cfg: MiraiConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: MiraiConfig): number {
...
export function resolveAcpProjectionSettings(cfg: MiraiConfig): AcpProjectionSettings {
