...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://github.com/adityagoyal009/Mirai/tree/main/gateway/docs/gateway/remote",
    "https://github.com/adityagoyal009/Mirai/tree/main/gateway/docs/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
