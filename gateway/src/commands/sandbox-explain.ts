...
const SANDBOX_DOCS_URL = "https://github.com/adityagoyal009/Mirai/tree/main/gateway/docs/sandbox";
...
export async function sandboxExplainCommand(
  ...
  lines.push("");
  lines.push(`${key("Docs:")} ${formatDocsLink("/sandbox", "github.com/adityagoyal009/Mirai/tree/main/gateway/docs/sandbox")}`);
