...
import { MiraiSchema } from "../config/zod-schema.js";
...
export function stripUnknownConfigKeys(config: MiraiConfig): {
  config: MiraiConfig;
  removed: string[];
} {
...
export function noteOpencodeProviderOverrides(cfg: MiraiConfig): void {
