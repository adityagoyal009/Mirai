...
vi.mock("mirai-gateway/plugin-sdk/reply-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("mirai-gateway/plugin-sdk/reply-runtime")>();
  return {
    ...actual,
...
vi.mock("mirai-gateway/plugin-sdk/channel-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("mirai-gateway/plugin-sdk/channel-runtime")>();
  return {
    ...actual,
