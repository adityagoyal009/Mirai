...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: MiraiConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: MiraiConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: MiraiConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: MiraiConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: MiraiConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: MiraiConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: MiraiConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: MiraiConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: MiraiConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: MiraiConfig) => MiraiConfig;
