...
export function listChannelMessageActions(cfg: MiraiConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: MiraiConfig): boolean {
...
export function supportsChannelMessageCards(cfg: MiraiConfig): boolean {
