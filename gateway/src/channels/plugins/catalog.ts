...
import { discoverMiraiPlugins } from "../../plugins/discovery.js";
import type { MiraiPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, MiraiPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["MIRAI_PLUGIN_CATALOG_PATHS", "MIRAI_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<MiraiPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: MiraiPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverMiraiPlugins({ workspaceDir: options.workspaceDir });
