...
function registerAndResolveStatusHandler(cfg: MiraiConfig): TelegramCommandHandler {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/mirai-sessions.json");
