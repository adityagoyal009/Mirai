...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.MIRAI_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: MiraiConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: MiraiConfig): string {
...
function mergeTelegramAccountConfig(cfg: MiraiConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: MiraiConfig): ResolvedTelegramAccount[] {
