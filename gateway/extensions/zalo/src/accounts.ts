...
import { createAccountListHelpers, type MiraiConfig } from "openclaw/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: MiraiConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: MiraiConfig): ResolvedZaloAccount[] {
