import type { MiraiConfig, MiraiPluginApi } from "openclaw/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: MiraiConfig): { id: string; name: string } {
