...
import { createAccountListHelpers, type MiraiConfig } from "openclaw/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: MiraiConfig): ResolvedGoogleChatAccount[] {
