...
// Default to Mirai workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".mirai", "workspace", "media", "inbound");
 ...
 * Format matches Mirai's expected attachment structure.
 */
