...
import type { MiraiPluginApi } from "openclaw/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: MiraiPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<MiraiPluginApi, "config">;
