...
import { createAccountListHelpers, type MiraiConfig } from "openclaw/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: MiraiConfig): ResolvedMattermostAccount[] {
