...
import type { MiraiPluginApi } from "openclaw/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("mirai/plugin-sdk/mattermost").MiraiConfig;
    runtime: import("mirai/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: MiraiPluginApi) {
