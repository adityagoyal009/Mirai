...
import { createAccountListHelpers, type MiraiConfig } from "openclaw/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: MiraiConfig): ResolvedBlueBubblesAccount[] {
