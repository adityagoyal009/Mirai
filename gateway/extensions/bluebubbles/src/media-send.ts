...
import { resolveChannelMediaMaxBytes, type MiraiConfig } from "openclaw/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: MiraiConfig; accountId?: string }): string[] {
