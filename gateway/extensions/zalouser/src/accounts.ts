...
import { createAccountListHelpers, type MiraiConfig } from "openclaw/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: MiraiConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: MiraiConfig; accountId?: string | null }) {
