...
function resolveZalouserOutboundChunkMode(cfg: MiraiConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: MiraiConfig, accountId?: string) {
