import type { MiraiConfig, PluginRuntime, ResolvedLineAccount } from "openclaw/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: MiraiConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: MiraiConfig; accountId: string }): Promise<{
