...
import type { MiraiConfig } from "openclaw/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: MiraiConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: MiraiConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: MiraiConfig): string {
