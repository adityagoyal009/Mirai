"""
Report API Routes
Provides simulation report generation, retrieval, and chat interfaces
"""
...
def generate_report():
    ...
    try:
        ...
        # Pre-generate report_id to return immediately to frontend
        import uuid
        ...
        def run_generate():
            try:
                ...
                # Generate report (with pre-generated report_id)
        ...
        return jsonify({
            ...
            "data": {
                ...
                "task_id": task_id,
                "status": "generating",
                "message": "Report generation task started, please check via /api/report/generate/status for progress",
...
def get_report_sections(report_id: str):
    ...
    Frontend can poll this API for generated section content without waiting for the entire report
...
def check_report_status(simulation_id: str):
    ...
    try:
        ...
        # Interview is unlocked only after report is completed
...
def get_console_log(report_id: str):
    ...
    Unlike the structured JSON logs from agent-log API,
...
def search_graph_tool():
    ...
    try:
        ...
        if not graph_id or not query:
            return jsonify({
                "success": False,
                "error": "Please provide graph_id 和 query"
            }), 400
