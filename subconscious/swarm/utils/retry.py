...
For handling retry logic of external API calls such as LLM
"""
...
class RetryableAPIClient:
    ...
    def call_with_retry(
        ...
        **kwargs
        ...
        """
        Execute function call with retries on failure
    ...
    def call_batch_with_retry(
        ...
        """
        Batch call with individual retries on each failed item
